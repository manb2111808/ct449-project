<template>
    <div class="container-fluid text-white-50 footer pt-5 mt-5" style="background-color: #43b3ae;">
                ...
                <div class="row g-5">
                            ...
                            <div class="row">
                                <ul class="col-lg-6 list-unstyled">
                                    <div class="" style="padding-left: 50px;">
                                        ...
                                        <li ><a class="btn-link text-light" href="/home/contact">Liên hệ</a></li>
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="footer-item d-flex flex-column mb-3 align-items-center">
                            ...
                            <div>
                                <div>
                                    <p>Địa chỉ: 123, đường số 1, khu tái định cư 923, Cần Thơ</p>
                                </div>
                                <div>
                                    <p>Email: onlibrary@gmail.com</p>
                                </div>
                                <div>
